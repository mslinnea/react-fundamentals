...
An example of a declarative programming is an SQL query.  The query defines what to return, but does not define how that happens.  A declarative approach is specifying the "WHAT"  An imperative approach is the "HOW".  Javascript can be both declarative and imperative.
